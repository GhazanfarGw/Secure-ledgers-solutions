...
function Navbar() {
  ...
  return (
    <header
      className={`fixed z-10 w-full duration-500 border-b border-opacity-30 ${
      ...
      <div className="mx-auto max-w-screen-xl px-4 md:px-10 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center py-3">
          ...
          <img
            src="./Desktop-Black Logo.png"
            alt="Logo"
            className="block md:hidden w-36 z-10"
          />
        </Link>
        ...
        <nav className="hidden lg:flex xl:flex space-x-6 text-sm tracking-wide items-center">
          ...
          >
            <button className="hover:text-[#1A2B6B] hover:font-semibold duration-500 hover:text-base hover:border-b-2 border-[#1A2B6B] font-bold flex items-center gap-1">
              More Services
            ...
            {/* Mega Menu Content */}
            {megaMenuOpen && (
              <div className="absolute left-0 duration-300 w-[700px] bg-white shadow-lg p-6 grid grid-cols-2 gap-6 border rounded-md">
                <div>
                  <ul className="space-y-4 text-sm">
                    <li><Link to="/online-payments" className="hover:text-[#1A2B6B] hover:font-semibold duration-500 hover:text-base hover:border-b-2 border-[#1A2B6B] font-bold">Online Payments</Link></li>
                    <li><Link to="/payroll" className="hover:text-[#1A2B6B] hover:font-semibold duration-500 hover:text-base hover:border-b-2 border-[#1A2B6B] font-bold">Crypto Payroll</Link></li>
                    <li><Link to="/billing" className="hover:text-[#1A2B6B] hover:font-semibold duration-500 hover:text-base hover:border-b-2 border-[#1A2B6B] font-bold">Billing</Link></li>
                    <li><Link to="/retail" className="hover:text-[#1A2B6B] hover:font-semibold duration-500 hover:text-base hover:border-b-2 border-[#1A2B6B] font-bold">Retail</Link></li>
                    <li><Link to="/funds-stuck" className="hover:text-[#1A2B6B] hover:font-semibold duration-500 hover:text-base hover:border-b-2 border-[#1A2B6B] font-bold">Funds Stuck</Link></li>
                    <li><Link to="/online-consulting" className="hover:text-[#1A2B6B] hover:font-semibold duration-500 hover:text-base hover:border-b-2 border-[#1A2B6B] font-bold">Online Consulting</Link></li>
                  </ul>
                </div>
              </div>
            )}
